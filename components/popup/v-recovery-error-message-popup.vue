...
.v-popup
  ...
  .v-popup__recover
    .v-popup__recover--header
      ...
      .v-popup__recover--header-descWrapper
        p.v-popup__recover--header-title Восстановление невозможно
      img.v-popup__recover--header-closeIcon(
